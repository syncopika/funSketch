...
function Frame(container, number){
    ...
    this.tainted = false; // set to true if any layers are edited - not used currently
    ...
    ***/
	...
	// change layer order for this frame
	// pass in 2 indexes of the layers that need to be swapped
	this.changeLayerOrder = function(index1, index2){
		let temp = this.canvasList[index1];
		this.canvasList[index1] = this.canvasList[index2];
		this.canvasList[index2] = temp;
	}
